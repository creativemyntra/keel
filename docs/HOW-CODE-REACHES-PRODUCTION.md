...
8. CREATE RELEASE TAG:
   ...
   └──────────────────┘    ↓
                           [GitHub: Release v3.17.0 created]
                           [Plugin bundle attached]
                           [Release notes published]
                           ↓
                    Users see:
                    "Keel v3.17.0 available"
                    [Download plugin]
```
...
Step 3: GitHub Actions Release Workflow triggers
        ...
        ├─ Build: npm run build → dist/keel-3.17.0.plugin
        ├─ Create Release: v3.17.0 on GitHub
        ├─ Upload: keel-3.17.0.plugin to release
        └─ Distribute:
...
Step 4: Users can install
        ...
        ├─ Extract keel-3.17.0.plugin
        └─ Run: /plugin add marketplace keel
           └─ Gets v3.17.0 with auth feature
...
4. **Release tag marks production release**
   - `git tag v3.17.0` marks prod branch as official release
