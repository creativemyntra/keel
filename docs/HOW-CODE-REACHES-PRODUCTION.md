...
Step 3: GitHub Actions Release Workflow triggers
        ...
        ├─ Build: npm run build → dist/keel-3.18.1.plugin
        ├─ Create Release: v3.18.1 on GitHub
        ├─ Upload: keel-3.18.1.plugin to release
        └─ Distribute:
...
Step 4: Users can install
        ...
        ├─ Extract keel-3.18.1.plugin
        └─ Run: /plugin add marketplace keel
           └─ Gets v3.18.1 with auth feature
...
4. **Release tag marks production release**
   - `git tag v3.18.1` marks prod branch as official release
