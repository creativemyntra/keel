...
> **Note:** Written 2026-07-09 against Keel v3.12.0 (8-phase pipeline). Current pipeline is 10 phases (v3.15.0+). Kept as a historical audit record — do not use as a process template.
