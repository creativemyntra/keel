...
|---------|-------------|--------|-------|
| 3.16.8 | 2026-07-27 | PRODUCTION | Forensic audit: 14 engine fixes (3 CRITICAL path traversal + log divergence, 4 HIGH webhook + gate budget, 4 MEDIUM artifact validation + lock timeout, 3 LOW CJIS warning + deprecation) |
