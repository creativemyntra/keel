# Keel AI-SDLC Framework v3.16.6 - Technical Specifications
...
- Registry: npmjs.org
- Installation: `npm install -g @amarsingh/keel@3.16.6`
- Status: READY (pending publish)

#### 3. Docker Container
- Image: `amarsingh/keel:3.16.6`
- Registry: Docker Hub
- Pull: `docker pull amarsingh/keel:3.16.6`
...
- Usage: `uses: creativemyntra/keel@v3.16.6`
...
### Infrastructure Scripts (v3.16.6)
