---
name: release-check
description: Full release-readiness gate before deployment to production.
---
...
| Gate | Status | Detail |
|------|--------|--------|
| Tests | [x] PASS | 47/47 green, 83% coverage |
| Lint | [x] PASS | 0 violations |
| Static Analysis | [x] PASS | 0 errors |
| Security | [x] PASS | 0 HIGH findings |
| CHANGELOG | [x] PASS | [3.0.0] entry present |
| Docs | [x] PASS | |
