...
Output a short health report: [BLOCKED] blockers (halted, integrity failures), [WARN] warnings (stale, over-cap, stale graph), [OK] healthy. One line per finding with the evidence path.
