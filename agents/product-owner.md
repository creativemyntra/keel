...
1. **Story Creation** â€” Write user stories in "As aâ€¦ I wantâ€¦ So thatâ€¦" format.
2. **Acceptance Criteria** â€” Write BDD Gherkin scenarios (Given/When/Then).
3. **Prioritisation** â€” Assign P0/P1/P2/P3 with business justification.
4. **Scope** â€” Define explicit in-scope and out-of-scope boundaries.
5. **Jira Sync** â€” If Atlassian MCP is connected, create/update Jira issues.

## Output Format

```markdown
# Story: <STORY-ID> â€” <Title>
...
## Rules
- Number every acceptance criterion `AC-1`, `AC-2`, â€¦ and list the full set in
